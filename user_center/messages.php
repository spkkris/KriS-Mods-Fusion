...
echo "<td align='right' width='100%' class='tbl2'><span class='small'>\n";
	echo "<strong>Panel u퓓tkownika v1.0 by PHP-Fusion Revolution</strong></span></td>\n"; 
	echo "</table>";  
	closetable();
}
...
echo "<td align='center' width='25%' class='tbl1'><span class='small'>\n";
	...
	echo "<td width='1%' class='tbl' style='white-space:nowrap;font-weight:".($_GET['folder']=="inbox"?"bold":"normal")."'><a href='".BASEDIR."user_center/messages.php?folder=inbox'>".$locale['402']." [".$bdata['inbox_total']."/".$msg_settings['pm_inbox']."]</a></td>\n";
	echo "<td width='1%' class='tbl' style='white-space:nowrap;font-weight:".($_GET['folder']=="outbox"?"bold":"normal")."'><a href='".BASEDIR."user_center/messages.php?folder=outbox'>".$locale['403']." [".$bdata['outbox_total']."/".$msg_settings['pm_sentbox']."]</a></td>\n";
	echo "<td width='1%' class='tbl' style='white-space:nowrap;font-weight:".($_GET['folder']=="archive"?"bold":"normal")."'><a href='".BASEDIR."user_center/messages.php?folder=archive'>".$locale['404']." [".$bdata['archive_total']."/".$msg_settings['pm_savebox']."]</a></td>\n";
	//dodano
	echo "<td width='1%' class='tbl' style='white-space:nowrap'><a href='".BASEDIR."user_center/messages_status.php?rowstart=0'>".$locale['444']."</a></td>\n";
	//
