...
if ((isset($_GET['action']) && $_GET['action'] == "2") && (isset($_GET['t']) && $_GET['t'] == "l")) {
	if (isset($_POST['add']) && (isset($_GET['submit_id']) && isnum($_GET['submit_id']))) {
		...
		$result = dbquery("DELETE FROM ".DB_SUBMISSIONS." WHERE submit_id='".$_GET['submit_id']."'");
		 $result = dbquery("UPDATE ".DB_USERS." SET points_normal=points_normal+".points('l')." WHERE user_id='".$data['user_id']."'"); 
...
if ((isset($_GET['action']) && $_GET['action'] == "2") && (isset($_GET['t']) && $_GET['t'] == "n")) {
	if (isset($_POST['publish']) && (isset($_GET['submit_id']) && isnum($_GET['submit_id']))) {
		...
		if (dbrows($result)) {
			...
			$result = dbquery("DELETE FROM ".DB_SUBMISSIONS." WHERE submit_id='".$_GET['submit_id']."'");
			 $result = dbquery("UPDATE ".DB_USERS." SET points_normal=points_normal+".points('n')." WHERE user_id='".$data['user_id']."'"); 
...
if ((isset($_GET['action']) && $_GET['action'] == "2") && (isset($_GET['t']) && $_GET['t'] == "a")) {
	if (isset($_POST['publish']) && (isset($_GET['submit_id']) && isnum($_GET['submit_id']))) {
		...
		if (dbrows($result)) {
			...
			$result = dbquery("DELETE FROM ".DB_SUBMISSIONS." WHERE submit_id='".$_GET['submit_id']."'");
			 $result = dbquery("UPDATE ".DB_USERS." SET points_normal=points_normal+".points('a')." WHERE user_id='".$data['user_id']."'"); 
...
if ((isset($_GET['action']) && $_GET['action'] == "2") && (isset($_GET['t']) && $_GET['t'] == "p")) {
	if (isset($_POST['publish']) && (isset($_GET['submit_id']) && isnum($_GET['submit_id']))) {
		...
		if (dbrows($result)) {
			...
			$result = dbquery("DELETE FROM ".DB_SUBMISSIONS." WHERE submit_id='".$_GET['submit_id']."'");
			 $result = dbquery("UPDATE ".DB_USERS." SET points_normal=points_normal+".points('p')." WHERE user_id='".$data['user_id']."'"); 
