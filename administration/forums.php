...
if (isset($_POST['save_cat'])) {
	...
	if (!isset($_GET['t']) || $_GET['t'] != "cat") {
		...
		$parent_result = dbquery("SELECT * FROM ".DB_FORUMS." ORDER BY forum_order");
		if (dbrows($parent_result)) {
		$parent_opts .= "<option value='0'".$parent_select.">--</option>\n";
			...
			echo "</tr>\n<tr>\n";
			echo "<td class='tbl'>".$locale['522b']."<br />\n";
