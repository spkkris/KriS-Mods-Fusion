...
if(iSUPERADMIN) {
  ...
  {     
    ...
    while($r = dbarray($wynik))
    {
      ...
      echo "<tr><td class='small'>".THEME_BULLET." <span style='font-weight: bold;'>".$r['user_ip']."</span> - Posiada ".number_format($r['num'])." u¿ytkowników.</td></tr>";
  ...
  {
    echo "<tr><td class='small'>Brak u¿ytkowników o tym samy ip.</td></tr>";
  }
  echo "</table>";
  closeside(); 
}
