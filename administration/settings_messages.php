...
if (isset($_POST['saveoptions'])) {
	...
	dbquery("UPDATE ".DB_MESSAGES_OPTIONS." SET 
		...
		dbquery("UPDATE ".DB_SETTINGS." SET 
		register_pm_subject = '".$_POST['register_pm_subject']."',
		register_pm_message = '".$_POST['register_pm_message']."'");
	if (!$result) { $error = 1; }
...
$options2 = dbarray(dbquery("SELECT * FROM ".DB_SETTINGS.""));
$register_pm_subject = $options2['register_pm_subject'];
$register_pm_message = $options2['register_pm_message'];
...
echo "</tr>\n<tr>\n";
echo "<td class='tbl2' align='center' colspan='2'>".$locale['904']."</td>\n";
echo "</tr>\n<tr>\n";
echo "<td class='tbl' width='50%'>".$locale['902']."</td>\n";
echo "<td class='tbl' width='50%'><input type='text' name='register_pm_subject' value='".$register_pm_subject."' maxleght='200' class='textbox' style='width:200px;'/>\n";
echo "</tr>\n<tr>\n";
echo "<td class='tbl' width='50%'>".$locale['903']."</td>\n";
echo "<td class='tbl' width='50%'><textarea name='register_pm_message' cols='50' rows='5' class='textbox' style='width:200px;'/>".$register_pm_message."</textarea>\n";
echo "</tr>\n<tr>\n";
