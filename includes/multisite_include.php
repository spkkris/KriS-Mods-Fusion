...
define("DB_INFUSION_TABLE", DB_PREFIX."rss_feeds");
define("DB_FORUMLOG", DB_PREFIX."forumlog");
define("DB_NICKS_MOD", DB_PREFIX."nicks_mod");
define("DB_EPS_POINTS", DB_PREFIX."eps_points");
define("DB_EPS_RANGS", DB_PREFIX."eps_rangs");
?>
