...
function showcomments($ctype, $cdb, $ccol, $cid, $clink) {
	...
	$result = dbquery(
		"SELECT tcm.*,user_name, user_avatar, user_sig FROM ".DB_COMMENTS." tcm
	...
	if (dbrows($result)) {
		...
		while ($data = dbarray($result)) {
			echo "<div class='tbl-border' style='margin-top:5px;'><div class='tbl2'>\n"; //class tbl-border, style='margin-top:5px;' added by jantom
...
/*Avatars in comments, added by Pieka, moded by jantom, start*/
				if($data['user_avatar'] != ""){
					echo"<img src='".IMAGES."avatars/".$data['user_avatar']."' class='comment-avatar' />";
						...
						echo"<img src='".IMAGES."avatars/noav.png' class='comment-avatar' />";
				}
				echo "</div>";
/*Avatars in comments, added by Pieka, moded by jantom, end*/
			...
			echo "<div class='tbl2'><div class='tbl1 comment_message' style='margin-left:60px;'><!--comment_message-->".nl2br(parseubb(parsesmileys($data['comment_message'])))."<br /><br /><br />\n"; //style='margin-left:60px;', <div class='tbl2'> added by jantom
